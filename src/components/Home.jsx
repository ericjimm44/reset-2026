...
export default function Home({
  ...
  const moments = [
    ...
    { k: "guidance", label: "Guidance", meta: "a note for you", icon: "heart" },
    { k: "why", label: "Why this", icon: "rel" },
  ];
  const quiet = [
  ...
  return (
    <div className="r26-hub r26-screen">
      ...
      {/* early nights happen; the seal is never locked away */}
      {!today.closed && !eveningReady && (
        <button className="r26-link" style={{ marginTop: 14 }} onClick={onSealStart}>
          End the day early
        </button>
      )}
